...
const BannerSection3 = ({thirdBannerStaticData}) => {
  return (
    <section className="fz-3-banner-section">
        <div className="container position-relative">
            ...
            >
                {thirdBannerStaticData.map((item) => (
                    <SwiperSlide className="fz-3-banner-single-slide" key={item.id}>
                        ...
                        <div className="fz-3-banner-product-cards">
                            <div className="fz-3-single-product">
                                ...
                                <h5 className="fz-3-single-product__title"><Link href="/shop">Chocolate Coated Cake</Link></h5>
                            ...
                            <div className="fz-3-single-product fz-3-single-product-2">
                                ...
                                <h5 className="fz-3-single-product__title"><Link href="/shop">Chocolate Layer Cake</Link></h5>
